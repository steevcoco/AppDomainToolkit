...
namespace AppDomainToolkit
{
	...
	public static class RemoteFuncAsync
	{
		...
		public static Task<TResult> InvokeAsync<TResult>(
			...
			Remote<RemoteFuncAsync<TResult>> proxy = Remote<RemoteFuncAsync<TResult>>.CreateProxy(domain);
			MarshalableTaskCompletionSource<TResult> tcs = new MarshalableTaskCompletionSource<TResult>();
		...
		public static Task<TResult> InvokeAsync<T1, TResult>(
			...
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFuncAsync<T1, TResult>> proxy = Remote<RemoteFuncAsync<T1, TResult>>.CreateProxy(domain);
			MarshalableTaskCompletionSource<TResult> tcs = new MarshalableTaskCompletionSource<TResult>();
		...
		public static Task<TResult> InvokeAsync<T1, T2, TResult>(
			...
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFuncAsync<T1, T2, TResult>> proxy = Remote<RemoteFuncAsync<T1, T2, TResult>>.CreateProxy(domain);
			MarshalableTaskCompletionSource<TResult> tcs = new MarshalableTaskCompletionSource<TResult>();
		...
		public static Task<TResult> InvokeAsync<T1, T2, T3, TResult>(
			...
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFuncAsync<T1, T2, T3, TResult>> proxy = Remote<RemoteFuncAsync<T1, T2, T3, TResult>>.CreateProxy(domain);
			MarshalableTaskCompletionSource<TResult> tcs = new MarshalableTaskCompletionSource<TResult>();
		...
		/// The Task result.
		/// </returns>
		public static Task<TResult> InvokeAsync<T1, T2, T3, T4, TResult>(
				AppDomain domain,
				T1 arg1,
				T2 arg2,
				T3 arg3,
			...
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFuncAsync<T1, T2, T3, T4, TResult>> proxy =
					Remote<RemoteFuncAsync<T1, T2, T3, T4, TResult>>.CreateProxy(domain);
			MarshalableTaskCompletionSource<TResult> tcs = new MarshalableTaskCompletionSource<TResult>();
		...
		/// The Task result.
		/// </returns>
		public static Task<TResult> InvokeAsync<T1, T2, T3, T4, T5, TResult>(
				AppDomain domain,
				T1 arg1,
				T2 arg2,
				T3 arg3,
			...
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFuncAsync<T1, T2, T3, T4, T5, TResult>> proxy
					= Remote<RemoteFuncAsync<T1, T2, T3, T4, T5, TResult>>.CreateProxy(domain);
			MarshalableTaskCompletionSource<TResult> tcs = new MarshalableTaskCompletionSource<TResult>();
	...
	public class RemoteFuncAsync<T1, TResult> : MarshalByRefObject
	{
		...
		public void Invoke(T1 arg1, Func<T1, Task<TResult>> toInvoke, MarshalableTaskCompletionSource<TResult> tcs) {
			...
			if (tcs == null)
				throw new ArgumentNullException(nameof(tcs));
			toInvoke.Invoke(arg1).ContinueWith(
					t => {
						if (t.IsCanceled)
							tcs.SetCanceled();
						else if (t.IsFaulted)
	...
	public class RemoteFuncAsync<T1, T2, TResult> : MarshalByRefObject
	{
		...
		public void Invoke(
				...
				T2 arg2,
				Func<T1, T2, Task<TResult>> toInvoke,
				MarshalableTaskCompletionSource<TResult> tcs) {
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			if (tcs == null)
				throw new ArgumentNullException(nameof(tcs));
			toInvoke.Invoke(arg1, arg2).ContinueWith(
					t => {
						if (t.IsCanceled)
							tcs.SetCanceled();
						else if (t.IsFaulted)
	...
	public class RemoteFuncAsync<T1, T2, T3, TResult> : MarshalByRefObject
	{
		...
		public void Invoke(
			...
			if (tcs == null)
				throw new ArgumentNullException(nameof(tcs));
			toInvoke.Invoke(arg1, arg2, arg3).ContinueWith(
					t => {
						if (t.IsCanceled)
							tcs.SetCanceled();
						else if (t.IsFaulted)
	...
	public class RemoteFuncAsync<T1, T2, T3, T4, TResult> : MarshalByRefObject
	{
		...
		public void Invoke(
			...
			if (tcs == null)
				throw new ArgumentNullException(nameof(tcs));
			toInvoke.Invoke(arg1, arg2, arg3, arg4).ContinueWith(
					t => {
						if (t.IsCanceled)
							tcs.SetCanceled();
						else if (t.IsFaulted)
	...
	public class RemoteFuncAsync<T1, T2, T3, T4, T5, TResult> : MarshalByRefObject
	{
		...
		public void Invoke(
			...
			if (tcs == null)
				throw new ArgumentNullException(nameof(tcs));
			toInvoke.Invoke(arg1, arg2, arg3, arg4, arg5).ContinueWith(
					t => {
						if (t.IsCanceled)
							tcs.SetCanceled();
						else if (t.IsFaulted)
