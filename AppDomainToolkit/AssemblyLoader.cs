...
namespace AppDomainToolkit
{
	...
	public enum LoadMethod
	{
		...
		/// <summary>
		/// Loads an assembly in the reflection only context, by <see cref="Assembly.ReflectionOnlyLoad(string)"/>.
		/// </summary>
		ReflectionOnlyLoad,

		/// <summary>
		/// Loads an assembly in the reflection only context, by <see cref="Assembly.ReflectionOnlyLoadFrom"/>.
		/// </summary>
					...
					IAssemblyLoader
	{
		/// <inheritdoc />
		/// <remarks>
		/// If the LoadMethod for this instance is set to LoadBits and the path to the PDB file is unspecified then we will attempt
		/// to guess
		...
		public IList<Assembly> LoadAssemblyWithReferences(LoadMethod loadMethod, string assemblyPath) {
			...
			Assembly assembly = LoadAssembly(loadMethod, assemblyPath);
			list.Add(assembly);
