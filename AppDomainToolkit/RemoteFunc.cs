...
namespace AppDomainToolkit
{
	...
	public static class RemoteFunc
	{
		...
		public static TResult Invoke<TResult>(AppDomain domain, Func<TResult> toInvoke) {
			...
			Remote<RemoteFunc<TResult>> proxy = Remote<RemoteFunc<TResult>>.CreateProxy(domain);
		...
		public static TResult Invoke<T, TResult>(AppDomain domain, T arg1, Func<T, TResult> toInvoke) {
			...
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFunc<T, TResult>> proxy = Remote<RemoteFunc<T, TResult>>.CreateProxy(domain);
		...
		public static TResult Invoke<T1, T2, TResult>(AppDomain domain, T1 arg1, T2 arg2, Func<T1, T2, TResult> toInvoke) {
			...
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFunc<T1, T2, TResult>> proxy = Remote<RemoteFunc<T1, T2, TResult>>.CreateProxy(domain);
		...
		public static TResult Invoke<T1, T2, T3, TResult>(
				...
				T2 arg2,
				T3 arg3,
				Func<T1, T2, T3, TResult> toInvoke) {
			if (domain == null)
				throw new ArgumentNullException(nameof(domain));
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFunc<T1, T2, T3, TResult>> proxy = Remote<RemoteFunc<T1, T2, T3, TResult>>.CreateProxy(domain);
		...
		public static TResult Invoke<T1, T2, T3, T4, TResult>(
				...
				T3 arg3,
				T4 arg4,
				Func<T1, T2, T3, T4, TResult> toInvoke) {
			if (domain == null)
				throw new ArgumentNullException(nameof(domain));
			if (toInvoke == null)
				throw new ArgumentNullException(nameof(toInvoke));
			Remote<RemoteFunc<T1, T2, T3, T4, TResult>> proxy = Remote<RemoteFunc<T1, T2, T3, T4, TResult>>.CreateProxy(domain);
